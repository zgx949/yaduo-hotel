...
-- CreateIndex
CREATE UNIQUE INDEX "OtaRoomMapping_platform_platformHotelId_platformRoomTypeId_key" ON "OtaRoomMapping"("platform", "platformHotelId", "platformRoomTypeId");
...
-- CreateIndex
CREATE UNIQUE INDEX "OtaCalendarItem_platform_platformHotelId_platformRoomTypeId_key" ON "OtaCalendarItem"("platform", "platformHotelId", "platformRoomTypeId", "date");
